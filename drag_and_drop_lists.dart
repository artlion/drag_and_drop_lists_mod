...
import 'drag_and_drop_list_expansion.dart';
...
class DragAndDropListsState extends State<DragAndDropLists> {
  ...
  dynamic _internalOnItemReorder(DragAndDropItem reordered, DragAndDropItem receiver) {
  ...
  dynamic _internalOnListReorder(
    DragAndDropListInterface reordered,
    DragAndDropListInterface receiver,
  ) {
  ...
  dynamic _internalOnItemDropOnLastTarget(
    DragAndDropItem newOrReordered,
    DragAndDropListInterface parentList,
  ...
  dynamic _internalOnListDropOnLastTarget(
  ...
  dynamic _onPointerMove(PointerMoveEvent event) {
    if (_pointerDown) {
  ...
  dynamic _onPointerDown(PointerDownEvent event) {
    _pointerDown = true;
    _pointerYPosition = event.position.dy;
    _pointerXPosition = event.position.dx;
  }

  dynamic _onPointerUp(PointerUpEvent event) {
    _pointerDown = false;
  }
